...
//         const decryptedMessage = decryptUC.execute(
//             keyPair.privateKey,
//             encryptedMessage,
//         )
...
//         console.log(
//             `CHAVE TWOFISH DA SESSÃO tamanho = ${key.key.length} \n${key.key}`,
//         )
//         const encryptedKey = encryptUC.execute(keyPair.publicKey, key.key)
//         console.log(
//             `encrypted twofish key in size ${encryptedKey.length}: ${encryptedKey}`,
//         )
//         const decryptedKey = decryptUC.execute(keyPair.privateKey, encryptedKey)
//         console.log(
//             `decrypted twofish key in size ${decryptedKey.length}: ${decryptedKey}`,
//         )
